(function($) {
    $(document).ready(function() {
        ...
        function telmarh_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    telmarh_remove_file($(this).parents('.section'));
                });
            });
        ...
        function telmarh_remove_file(selector) {
            ...
            selector.find('.upload-button').live('click', function() {
                telmarh_add_file(event, $(this).parents('.section'));
            });
        }
