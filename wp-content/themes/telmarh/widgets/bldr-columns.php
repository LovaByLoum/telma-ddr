...
class telmarh_columns extends WP_Widget {
	
// constructor

    function telmarh_columns() {

		$widget_ops = array('classname' => 'telmarh_columns_widget', 'description' => __( 'Populate four columns for your home page.', 'telmarh') );

        parent::__construct(false, $name = __('Home Page Columns', 'telmarh'), $widget_ops);

		$this->alt_option_name = 'telmarh_columns_widget';
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_number_cols')); ?>"><?php _e('Number of Columns. <em>If left empty, the default number is 4.</em>', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_icon_one')); ?>"><?php _e('First column icon. Use fortawesome.github.io/Font-Awesome/cheatsheet/ to choose icons.', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_one')); ?>"><?php _e('First column name', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_one_text')); ?>"><?php _e('First column text', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_one_link')); ?>"><?php _e('Link for first button', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field ( $this->get_field_id('column_one_button')); ?>"><?php _e('Title for first button', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_icon_two')); ?>"><?php _e('Second column icon. Use fortawesome.github.io/Font-Awesome/cheatsheet/ to choose icons.', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_two')); ?>"><?php _e('Second column name', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_two_text')); ?>"><?php _e('Second column text', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_two_link')); ?>"><?php _e('Link for second button', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_two_button')); ?>"><?php _e('Title for second button', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_icon_three')); ?>"><?php _e('Third column icon. Use fortawesome.github.io/Font-Awesome/cheatsheet/ to choose icons.', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_three')); ?>"><?php _e('Third column name', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_three_text')); ?>"><?php _e('Third column text', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_three_link')); ?>"><?php _e('Link for third button', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_three_button')); ?>"><?php _e('Title for third button', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_icon_four')); ?>"><?php _e('Fourth column icon. Use fortawesome.github.io/Font-Awesome/cheatsheet/ to choose icons.', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_four')); ?>"><?php _e('Fourth column name', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_four_text')); ?>"><?php _e('Fourth column text', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_four_link')); ?>"><?php _e('Link for fourth button', 'telmarh'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('column_four_button')); ?>"><?php _e('Title for fourth button', 'telmarh'); ?></label>
	...
	function update($new_instance, $old_instance) { 
		...
		if ( isset($alloptions['telmarh_columns']) )

			delete_option('telmarh_columns');
	...
	function flush_widget_cache() {
		...
		wp_cache_delete('telmarh_columns', 'widget');
	...
	function widget($args, $instance) {
		...
		if ( ! $this->is_preview() ) {
			...
			$cache = wp_cache_get( 'telmarh_columns', 'widget' );
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'telmarh_columns', $cache, 'widget' );
