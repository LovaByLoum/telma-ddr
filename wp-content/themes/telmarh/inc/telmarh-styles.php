...
function telmarh_add_customizer_css() {
	...
	<style>
		...
		<?php if ( get_theme_mod( 'telmarh_page_hp_content_color' ) ) : ?>
		.site-header .main-navigation a:hover { color: <?php echo esc_attr( get_theme_mod( 'telmarh_page_hp_content_color', __( '#404040', 'telmarh' ) )) ?>; }
		<?php endif; ?>
		...
		<?php if ( get_theme_mod( 'telmarh_page_hp_background_color' ) ) : ?>
		#page-full-entry-content-homepage { background: <?php echo esc_attr( get_theme_mod( 'telmarh_page_hp_background_color', __( '#404040', 'telmarh' ) )) ?> !important; }
		<?php endif; ?>

		<?php if ( get_theme_mod( 'telmarh_page_hp_content_color' ) ) : ?>
		#page-full-entry-content-homepage { color: <?php echo esc_attr( get_theme_mod( 'telmarh_page_hp_content_color', __( '#404040', 'telmarh' ) )) ?> !important; }
		<?php endif; ?>
