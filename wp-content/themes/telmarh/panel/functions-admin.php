...
// admin area styling
function telmarh_custom_colors() {
...
add_action('admin_head', 'telmarh_custom_colors');
...
add_action( 'tgmpa_register', 'telmarh_recommend_plugin' );
function telmarh_recommend_plugin() {
