...
get_header(); ?>
    <section id="page-full-entry-content" class="registration-form">
                        ...
                        <form class="comment-form" id="inscription_user" autocomplete="off" action="<?php echo get_permalink( $post->ID );?>" method="post">
                            ...
                            <div class="control-group open">
                                ...
                                <div class="content-accordion">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 form-field niveau-required" <?php if ( $_POST['niveau_etude'] == "autre" ):?>style="display: block;" <?php endif;?>>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 post-required" <?php if ( isset( $_POST['en_poste'] ) && $_POST['en_poste'] == 1 ):?>style="display: block;" <?php endif;?>>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="radio-item">
                                                <?php foreach ( $permis as $key=>$val ) :?>
                                                    <label class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" value="<?php echo $key;?>" name="permis" <?php if ( isset( $_POST['permis'] ) && intval( $_POST['permis'] ) == $key ):?>checked="checked"<?php endif;?><?php if ( !isset( $_POST['permis'] ) && $key == 0 ):?>checked="checked"<?php endif;?>>
                                        ...
                                        <div class="form-group permis-required col-lg-4" <?php if ( isset( $_POST['permis'] ) && $_POST['permis'] == 1 ):?>style="display: block;" <?php endif;?> >
                                            <h5>Catégories <span class="required">*</span></h5>
                                            <ul class="checkbox-item checkbox-list">
                                                <?php foreach ( $catPermis1 as $key=> $val ):?>
                                                    <li>
                                                        <label class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" value="<?php echo $key;?>" name="permCat[]" class="permCat" <?php if ( isset( $_POST['permCat'] ) && in_array( $key, $_POST['permCat'] ) ):?>checked="checked" <?php endif;?> >
                                                            <span class="custom-control-indicator"></span>
                                                            <span class="custom-control-description"><?php echo $val;?></span>
                                                        </label>
                                                    </li>
                                        ...
                                        <div class="form-group permis-required col-lg-4" <?php if ( isset( $_POST['permis'] ) && $_POST['permis'] == 1 ):?>style="display: block;" <?php endif;?> >
                                            ...
                                            <ul class="checkbox-item checkbox-list">
                                                <?php $i = 1;  foreach ( $catPermis2 as $key=>$val ):?>
                                                    <li>
                                                        <label class="custom-control custom-checkbox <?php if ( count( $catPermis2 ) == $i ):?>latest<?php endif;?>">
                                                            <input type="checkbox" class="custom-control-input" value="<?php echo $key;?>" name="permCat[]" class="permCat" <?php if ( isset( $_POST['permCat'] ) && in_array( $key, $_POST['permCat'] ) ):?>checked="checked" <?php endif;?> >
                                                            <span class="custom-control-indicator"></span>
                                                            <span class="custom-control-description"><?php echo $val;?></span>
                                                        </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio-item">
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="projet" checked="checked">
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Non</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1" name="projet">
                                            <span class="custom-control-indicator"></span>
