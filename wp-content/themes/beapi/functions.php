<?php
/**
 * beapi functions and definitions
 *
 * Sets up the theme and provides some helper functions. Some helper functions
 * are used in the theme as custom template tags. Others are attached to action and
 * filter hooks in WordPress to change core functionality.
 *
 * The first function, beapi_setup(), sets up the theme by registering support
 ...
 *     remove_filter( 'excerpt_length', 'beapi_excerpt_length' );
 *     ...
 * }
 * </code>
 *
...
/**
 * Tell WordPress to run beapi_setup() when the 'after_setup_theme' hook is run.
 */
add_action( 'after_setup_theme', 'beapi_setup' );

if ( ! function_exists( 'beapi_setup' ) ):
function beapi_setup() {
	...
	/* Make beapi available for translation.
	 * Translations can be added to the /languages/ directory.
	 * If you're building a theme based on beapi, use a find and replace
	 * to change 'beapi' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'beapi', get_template_directory() . '/languages' );
	...
	register_nav_menu( 'primary', __( 'Primary Menu', 'beapi' ) );
