(function($) {
    $(document).ready(function() {
        ...
        function beapi_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    beapi_remove_file($(this).parents('.section'));
                });
            });
        ...
        function beapi_remove_file(selector) {
            ...
            selector.find('.upload-button').live('click', function() {
                beapi_add_file(event, $(this).parents('.section'));
            });
        }
