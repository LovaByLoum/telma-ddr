...
This plugin is an add-on for Advanced Custom Fields. It allows you to choose URL between posts link and external link
...
**This plugin requires the [Advanced Custom Fields](http://wordpress.org/extend/plugins/advanced-custom-fields/) plugin (version 4.0+)

Use ACF Api get_field( _metaname_, _post_id_ ) to load the field value.
...
1. Now you find a link on all post types for archive the item and a menu to manage archives and purge
