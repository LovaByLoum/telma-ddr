	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				printBtn: '<div title="Imprimer" class="fancybox-item fancybox-print"></div>',
...
//			F.outer = $('.fancybox-outer', F.wrap).css('padding', F.current.padding + 'px');
			F.outer = $('.fancybox-outer', F.wrap).css({paddingTop: F.current.padding, paddingRight: F.current.padding, paddingLeft: F.current.padding, paddingBottom: F.current.paddingBottom?F.current.paddingBottom:F.current.padding});
		...
		_afterZoomIn: function () {
			...
			if (current.printBtn) {	
				$(current.tpl.printBtn).appendTo(F.outer).bind('click.fb', F.print);
			}
